...
k_values=[4,5,6,7,8]
birch_models={k: joblib.load(f'birch_clustering_{k}.pkl') for k in k_values}
...
def predict():
    ...
    birch_clustering=birch_models[k]
    phase=birch_clustering.predict(encoded_data)[0]
    ...
    def generate_plot():
        ...
        ax.set_title(f'Birch Clustering of Flight Phases (K={k})')
